                ...
                <div className={`md:flex ${index % 2 === 0 ? 'md:flex-row-reverse' : 'md:flex-row'} items-start justify-between md:w-full`}>
                  ...
                  <div className="bg-slate-900/50 border border-slate-800 hover:border-tech-primary/50 transition-colors p-6 rounded-xl md:w-[calc(50%-2rem)] group">
                    <div className="flex flex-wrap items-center justify-between mb-2 gap-2">
                      <h3 className="text-xl font-bold text-white group-hover:text-tech-primary transition-colors">{job.role}</h3>
                      <span className="flex items-center text-xs font-mono text-tech-accent bg-tech-accent/10 px-2 py-1 rounded">
                    ...
                    <div className="flex items-center text-slate-400 mb-4 text-sm">
                      ...
                      <span className="font-semibold mr-4">{job.company}</span>
